/**
 * nclaw-jsi.ts — NcLawJSI interface spec: libnclaw Rust→RN JSI seam.
 *
 ...
 *
 * Inputs:  Types 1:1 mapped from nclaw/core/src/types.rs (see nclaw-jsi.types.ts).
 ...
 *
 * Constraints: This is the ONLY place the JSI interface + stub + registry are defined.
 ...
 *            nclaw-jsi.types.ts (all mirrored types — extracted for 300-line cap)
